...
export const usaValidator = (value) => !value ?
            "Number of guests is required" :
            value == 'male' ? "" : "MediaLab is a US entity, therefore to compel any user data law enforcement will be required to cooperate with the US government through an appropriate legal mechanism. We will only accept valid legal process from a US governmental entity or court.";
